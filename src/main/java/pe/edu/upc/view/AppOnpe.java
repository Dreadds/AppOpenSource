...
import pe.edu.upc.model.dao.daoGrupoVotacion;
import pe.edu.upc.model.dao.daoPersona;
import pe.edu.upc.model.entity.GrupoVotacion;
import pe.edu.upc.model.entity.Persona;
import pe.edu.upc.service.IGeneric;
...
public class AppOnpe {
	...
	public static void main(String[] args) {
		...
		IGrupo lGrupo = new daoGrupoVotacion();
		IPersona lPersona = new daoPersona();
	...
	public static void regGrupo(IGrupo lGrupo) {
		...
		GrupoVotacion oGrupo = new GrupoVotacion();
	...
	public static void lisGrupo(IGrupo lGrupo) {
		...
		for (int i = 0; i < lGrupo.contar(); i++) {
			GrupoVotacion oGrupo = lGrupo.obtenerElemento(i);
	...
	public static void regPersona(IPersona lPersona, IGrupo lGrupo) {
		...
		while (true) {
			...
			GrupoVotacion oGrupo = lGrupo.getByGrupoNroGrupo(oScanner.nextLine());
